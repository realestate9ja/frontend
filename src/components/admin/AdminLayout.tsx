        ...
        <div className="flex-1 flex flex-col">
          <header className="h-16 flex items-center border-b bg-background/80 backdrop-blur-sm px-6 gap-4 sticky top-0 z-10">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <Input placeholder="Search anything..." className="pl-9 bg-muted/50 border-0 focus-visible:bg-background" />
            </div>
            <div className="ml-auto flex items-center gap-3">
              ...
              <Link to="/admin/settings" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity cursor-pointer">
